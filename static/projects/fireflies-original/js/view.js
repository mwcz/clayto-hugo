  ...
  _createClass(ParticleView, [
    {
      ...
      value: function init() {
        ...
        for (var i = 0, i3 = 0; i < this.count; i++, i3 = i3 + 3) {
          ...
          this.sizes[i] =
            this.heightScale * this.size + (Math.random() * this.size) / 2;
        }
      ...
      value: function updateFleeOffsets() {
        ...
        for (var i = 0, i3 = 0; i < this.count; i++, i3 = i3 + 3) {
          ...
          var distN =
            ...
            this.flee.proximity; // normalized distance
    ...
    },
    {
      ...
      value: function updatePositionsTween() {
        ...
        var fleeDistance =
          this.flee.distance === 0 ? 0 : 1 / this.flee.distance;
        for (var i = 0, i3 = 0; i < this.count; i++, i3 = i3 + 3) {
          ...
          var time = this.tweenTimer[i];
          var travelx = this.tween.xfunc(
            time,
            x,
            xdest - x,
            this.tween.duration
          );
          var travely = this.tween.yfunc(
            time,
            y,
            ydest - y,
            this.tween.duration
