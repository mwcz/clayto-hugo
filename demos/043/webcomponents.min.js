...
!(function() {
      ...
      (n.prototype = {
        ...
        calcSplices: function(e, n, s, c, l, u) {
          ...
          if (
            ...
            return [];
          if (n == s) {
            for (var f = t(n, [], 0); u > l; ) f.removed.push(c[l++]);
            return [f];
          }
            ...
            for (var l = 0; l < c.length; l++) {
              ...
              if (
                ...
                ("attributes" !== n ||
                  !d.attributeFilter ||
                  (null === o.namespace &&
                    -1 !== d.attributeFilter.indexOf(o.name))) &&
      ...
      [Node, Window].forEach(function(e) {
        ...
        (N.prototype = {
          ...
          dispatchEvent: function(t) {
            ...
            var o;
            D(this, r) ||
              ((o = function() {}), this.addEventListener(r, o, !0));
            try {
    ...
    (function(e) {
      ...
      function p(n, r, o, i, a) {
        var s,
          c = g(this),
          l = v(this).root;
        if (l instanceof e.wrappers.ShadowRoot)
          ...
          poolDistribution: function(e, t) {
            if (!(e instanceof L))
              if (e instanceof O) {
                ...
                if (!r)
                  for (var i = n.firstChild; i; i = i.nextSibling) w(i, n);
              } else
    ...
    (function(e) {
      ...
      var u = {
          ...
          removeStyles: function(e, t) {
            for (var n, r = 0, o = t.length; o > r && (n = t[r]); r++)
          ...
          registerRoot: function(e, t, n) {
            ...
            return (
              i && (r.scopeStyles = i.scopeStyles.concat(r.scopeStyles)), r
            );
          },
  ...
  (function(e) {
    ...
    function o(e) {
      ...
      return t > 32 && 127 > t && -1 == [34, 35, 60, 62, 63, 96].indexOf(t)
        ? e
        : encodeURIComponent(e);
    }
    function i(e) {
      var t = e.charCodeAt(0);
      return t > 32 && 127 > t && -1 == [34, 35, 60, 62, 96].indexOf(t)
        ? e
        : encodeURIComponent(e);
    }
    function a(e, a, s) {
    ...
    var a = e.path,
      ...
      p = {
        ...
        parseLink: function(e) {
          t(e)
            ? this.parseImport(e)
            : ((e.href = e.href), this.parseGeneric(e));
        },
  ...
  window.CustomElements.addModule(function(e) {
    ...
    function i() {
      _ = !1;
      for (var e, t = S, n = 0, r = t.length; r > n && (e = t[n]); n++) e();
      S = [];
    }
    function a(e) {
      E
  ...
  window.CustomElements.addModule(function(e) {
    ...
    function l(e) {
      return e ? _[e.toLowerCase()] : void 0;
    }
    function u(e, t) {
      _[e] = t;
    }
