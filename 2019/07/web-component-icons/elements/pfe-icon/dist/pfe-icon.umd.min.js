!(function (e, o) {
  "object" == typeof exports && "undefined" != typeof module
    ? (module.exports = o(require("../../pfelement/dist/pfelement.umd")))
    : "function" == typeof define && define.amd
    ? define(["../../pfelement/dist/pfelement.umd"], o)
    : (e.PfeIcon = o(e.PFElement));
})(this, function (e) {
  "use strict";
      ...
      (o(c, [
        {
          key: "resolveIconName",
          value: function (e) {
            return this._resolveIconName(e, this.name, this.path);
          },
        },
      ]),
      c);
  function c(e, o, t) {
    r(this, c), (this.name = e), (this.path = o), (this._resolveIconName = t);
  }
  function t(e, o, t) {
    var r = /^([^-]+)-(.*)/.exec(e);
    return t + "/" + (o + "-icon-" + a(r, 3)[2]) + ".svg";
  }
  var d,
    l =
      ((function (e, o) {
      ...
      o(
        ...
        [
          ...
          },
          {
            key: "has_fallback",
            get: function () {
              return 0 < this.children.length || 0 < this.innerText.length;
            },
          },
        ],
        [
          ...
          },
          {
            ...
            get: function () {
              return {
                ...
                circled: { title: "Circled", type: "boolean", prefixed: !1 },
              };
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e) {
              var o =
                ...
                n = t.set;
              if (n) {
                var a = n.resolveIconName(o);
                this.image.setAttribute("xlink:href", a),
                  (function (e) {
                    var o = "filter-" + Math.random().toString().slice(2, 10);
                    (e.shadowRoot.querySelector("svg image").style.filter =
                      "url(#" + o + ")"),
                      e.shadowRoot
                ...
                (this._handleAddIconSet = (function (o, t) {
                  return function (e) {
                    t === e.detail.set.name &&
                      (document.body.removeEventListener(
                        l.EVENTS.ADD_ICON_SET,
                        o._handleAddIconSet
                      ),
                      o.updateIcon());
                  };
        ...
        [
          {
            ...
            value: function (e) {
              var o = e.split("-"),
                t = a(o, 1)[0];
              return { setName: t, set: this._iconSets[t] };
            },
          },
          {
            key: "addIconSet",
            value: function (e, o, t) {
              ...
              (this._iconSets[e] = new i(e, o, t)),
                document.body.dispatchEvent(
                  new CustomEvent(this.EVENTS.ADD_ICON_SET, {
                    bubbles: !1,
                    detail: { set: this._iconSets[e] },
                  })
                );
            },
          },
  ...
  function s() {
    ...
    })(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s));
    return (
      (e.image = e.shadowRoot.querySelector("svg image")),
      e.image.addEventListener("load", function () {
        return (function (e) {
          e.classList.remove("load-failed");
        })(e);
      }),
      e.image.addEventListener("error", function () {
        return (function (e) {
          e.classList.add("load-failed"),
            e.has_fallback && e.classList.add("has-fallback");
        })(e);
      }),
      e
    );
  ...
  return (
    ...
    [
      ...
      return d.addIconSet(e.name, e.path, t);
    }),
    e.create(l),
    l
  );
