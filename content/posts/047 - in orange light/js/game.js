...
var Game = function (_Phaser$Game) {
    ...
    function Game() {
        ...
        var _this = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).call(this, config.CANVAS_WIDTH, config.CANVAS_HEIGHT, Phaser.AUTO, document.querySelector('#iol-sky-demo'), null, false, false));
