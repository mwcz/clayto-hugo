...
var PlayState = (function(_Phaser$State) {
  ...
  function PlayState() {
    ...
    return _possibleConstructorReturn(
      this,
      (PlayState.__proto__ || Object.getPrototypeOf(PlayState)).apply(
        this,
        arguments
      )
    );
  ...
  _createClass(PlayState, [
    ...
    },
    {
      ...
      value: function drawInitialScene() {
        ...
        this.sprites.mountain4 = this.game.add.sprite(0, y + 200, "mountain4");
        this.sprites.mountain3 = this.game.add.sprite(0, y + 200, "mountain3");
        this.sprites.mountain2 = this.game.add.sprite(0, y + 200, "mountain2");
        this.sprites.mountain1 = this.game.add.sprite(0, y + 200, "mountain1");
        this.sprites.outline = this.game.add.sprite(0, y + 200, "outline");

        // animate the sky
        this.sprites.sky2.position.y =
          this.sprites.sky2.height + this.sprites.sky2.position.y;
        ...
        ["mountain1", "mountain2", "mountain3", "mountain4"].forEach(function(
          num
        ) {
